    ...
    */
    ...
    Output.prototype.show_results = function (tests, harness_status) {
        ...
        if (harness_url !== null) {
            ...
            stylesheet.setAttribute("href", harness_url + "testharness_xow.css");
    ...
    AssertionError.prototype.get_stack = function() {
        ...
        var re_text = script_url ? script_url.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&') : "\\btestharness_xow.js";
    ...
    function get_script_url()
    {
        ...
        for (var i = 0; i < scripts.length; i++) {
            ...
            var matches = src && src.match(/^(.*\/|)testharness\_xow\.js$/);
            if (matches) {
                return src;
            }
        }
