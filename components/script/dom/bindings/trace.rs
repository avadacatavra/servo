...
use app_units::Au;
#[cfg(feature = "servo")] use canvas_traits::canvas::{CanvasGradientStop, LinearGradientStyle, RadialGradientStyle};
#[cfg(feature = "servo")] use canvas_traits::canvas::{CompositionOrBlending, LineCapStyle, LineJoinStyle, RepetitionStyle};
#[cfg(feature = "servo")] use canvas_traits::webgl::{WebGLBufferId, WebGLFramebufferId, WebGLProgramId, WebGLRenderbufferId};
#[cfg(feature = "servo")] use canvas_traits::webgl::{WebGLChan, WebGLContextShareMode, WebGLError, WebGLPipeline, WebGLMsgSender};
#[cfg(feature = "servo")] use canvas_traits::webgl::{WebGLReceiver, WebGLSender, WebGLShaderId, WebGLTextureId, WebGLVertexArrayId};
#[cfg(feature = "servo")] use canvas_traits::webgl::{WebGLSLVersion, WebGLVersion};
#[cfg(feature = "servo")] use cssparser::RGBA;
#[cfg(feature = "servo")] use devtools_traits::{CSSError, TimelineMarkerType, WorkerId};
#[cfg(feature = "servo")] use dom::abstractworker::SharedRt;
...
#[cfg(feature = "servo")] use dom::bindings::utils::WindowProxyHandler;
#[cfg(feature = "servo")] use dom::document::PendingRestyle;
#[cfg(feature = "servo")] use encoding_rs::Encoding;
#[cfg(feature = "servo")] use euclid::{Transform2D, Transform3D, Point2D, Vector2D, Rect, TypedSize2D, TypedScale};
use euclid::Length as EuclidLength;
use html5ever::{Prefix, LocalName, Namespace, QualName};
use html5ever::buffer_queue::BufferQueue;
use html5ever::tendril::IncompleteUtf8;
#[cfg(feature = "servo")] use hyper::header::Headers;
#[cfg(feature = "servo")] use hyper::method::Method;
#[cfg(feature = "servo")] use hyper::mime::Mime;
#[cfg(feature = "servo")] use hyper::status::StatusCode;
#[cfg(feature = "servo")] use ipc_channel::ipc::{IpcReceiver, IpcSender};
use js::glue::{CallObjectTracer, CallValueTracer};
use js::jsapi::{GCTraceKindToAscii, Heap, JSObject, JSTracer, TraceKind};
use js::jsval::JSVal;
use js::rust::Runtime;
#[cfg(feature = "servo")] use metrics::{InteractiveMetrics, InteractiveWindow};
...
#[cfg(feature = "servo")] use net_traits::filemanager_thread::RelativePos;
#[cfg(feature = "servo")] use net_traits::image::base::{Image, ImageMetadata};
#[cfg(feature = "servo")] use net_traits::image_cache::{ImageCache, PendingImageId};
#[cfg(feature = "servo")] use net_traits::request::{Request, RequestInit};
#[cfg(feature = "servo")] use net_traits::response::{Response, ResponseBody};
#[cfg(feature = "servo")] use net_traits::response::HttpsState;
#[cfg(feature = "servo")] use net_traits::storage_thread::StorageType;
#[cfg(feature = "servo")] use offscreen_gl_context::GLLimits;
...
#[cfg(feature = "servo")] use script_layout_interface::OpaqueStyleAndLayoutData;
#[cfg(feature = "servo")] use script_layout_interface::reporter::CSSErrorReporter;
#[cfg(feature = "servo")] use script_layout_interface::rpc::LayoutRPC;
...
#[cfg(feature = "servo")] use serde::{Deserialize, Serialize};
...
#[cfg(feature = "servo")] use style::attr::{AttrIdentifier, AttrValue, LengthOrPercentageOrAuto};
use style::context::QuirksMode;
#[cfg(feature = "servo")] use style::element_state::*;
#[cfg(feature = "servo")] use style::media_queries::MediaList;
#[cfg(feature = "servo")] use style::properties::PropertyDeclarationBlock;
#[cfg(feature = "servo")] use style::selector_parser::{PseudoElement, Snapshot};
#[cfg(feature = "servo")] use style::shared_lock::{SharedRwLock as StyleSharedRwLock, Locked as StyleLocked};
#[cfg(feature = "servo")] use style::stylesheet_set::StylesheetSet;
use style::stylesheets::{CssRules, FontFaceRule, KeyframesRule, MediaRule, Stylesheet};
#[cfg(feature = "servo")] use style::stylesheets::{NamespaceRule, StyleRule, ImportRule, SupportsRule, ViewportRule};
#[cfg(feature = "servo")] use style::stylesheets::keyframes_rule::Keyframe;
#[cfg(feature = "servo")] use style::values::specified::Length;
#[cfg(feature = "servo")] use time::Duration;
use uuid::Uuid;
#[cfg(feature = "servo")] use webrender_api::{DocumentId, ImageKey};
#[cfg(feature = "servo")] use webvr_traits::WebVRGamepadHand;
...
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(CSSError);

unsafe_no_jsmanaged_fields!(&'static Encoding);

unsafe_no_jsmanaged_fields!(Reflector);

#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(Duration);
...
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(Image, ImageMetadata, ImageCache, PendingImageId);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(Metadata);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(NetworkError);
unsafe_no_jsmanaged_fields!(Atom, Prefix, LocalName, Namespace, QualName);
unsafe_no_jsmanaged_fields!(TrustedPromise);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(PropertyDeclarationBlock);
// These three are interdependent, if you plan to put jsmanaged data
// in one of these make sure it is propagated properly to containing structs
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(DocumentActivity, WindowSizeData, WindowSizeType);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(BrowsingContextId, FrameType, PipelineId, TopLevelBrowsingContextId);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(TimerEventId, TimerSource);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(TimelineMarkerType);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WorkerId);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(BufferQueue, QuirksMode, IncompleteUtf8);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(Runtime);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(Headers, Method);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WindowProxyHandler);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(UntrustedNodeAddress);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(LengthOrPercentageOrAuto);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(RGBA);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(StorageType);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(CanvasGradientStop, LinearGradientStyle, RadialGradientStyle);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(LineCapStyle, LineJoinStyle, CompositionOrBlending);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(RepetitionStyle);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLError, GLLimits);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(TimeProfilerChan);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(MemProfilerChan);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(PseudoElement);
unsafe_no_jsmanaged_fields!(Length);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(ElementSelectorFlags);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(ElementState);
unsafe_no_jsmanaged_fields!(DOMString);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(Mime);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(AttrIdentifier);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(AttrValue);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(Snapshot);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(PendingRestyle);
unsafe_no_jsmanaged_fields!(Stylesheet);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(HttpsState);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(Request);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(RequestInit);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(SharedRt);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(StyleSharedRwLock);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(TouchpadPressurePhase);
unsafe_no_jsmanaged_fields!(USVString);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(ReferrerPolicy);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(Response);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(ResponseBody);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(ResourceThreads);
unsafe_no_jsmanaged_fields!(StatusCode);
unsafe_no_jsmanaged_fields!(SystemTime);
unsafe_no_jsmanaged_fields!(Instant);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(RelativePos);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(OpaqueStyleAndLayoutData);
unsafe_no_jsmanaged_fields!(PathBuf);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(CSSErrorReporter);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(DrawAPaintImageResult);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(DocumentId);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(ImageKey);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLBufferId);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLChan);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLContextShareMode);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLFramebufferId);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLMsgSender);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLPipeline);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLProgramId);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLRenderbufferId);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLShaderId);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLTextureId);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLVertexArrayId);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLVersion);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebGLSLVersion);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(MediaList);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(WebVRGamepadHand);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(ScriptToConstellationChan);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(InteractiveMetrics);
#[cfg(feature = "servo")] unsafe_no_jsmanaged_fields!(InteractiveWindow);
